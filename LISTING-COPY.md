...
**Demo**
https://client-portal-demo-dun.vercel.app
...
There's a demo at https://client-portal-demo-dun.vercel.app. Log in as Mike (viewer) and you see one entity. Log in as Sarah (admin) and you see two. Visit the RLS demo page and click the write-violation button — it hits the real database and returns the actual Postgres 42501 error. Worth clicking just to see it.
...
$2,500. Full source + deploy guide. https://client-portal-demo-dun.vercel.app | https://github.com/olukareem/enclave

---

## After deploying — checklist before pasting these anywhere

- [ ] Replace all `https://client-portal-demo-dun.vercel.app` placeholders with the live Vercel URL
- [ ] Replace all `https://github.com/olukareem/enclave` placeholders with the public GitHub repo URL
