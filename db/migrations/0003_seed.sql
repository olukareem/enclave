...
-- (which link users to entities) are created in 0004_demo_users.sql
-- after the corresponding public.users rows exist.
--
...
-- ── Documents ────────────────────────────────────────────────────────────
-- Format: storage_path is `{entity_uuid}/doc-{slug}.{ext}` so the Vercel Blob
-- folder structure matches the entity FK. uploaded_by references
